...
//import Dropdown from './Dropdown'; //This import is replaced with a npm component below.
import {Dropdown} from 'react-app-searchable-dropdown-component';
import departmentList from '../data/departments';
import stateList from '../data/states';

const DatePicker = lazy(() => import('react-datepicker'));
const ArrowDropDownOutlinedIcon = lazy(() => import('@mui/icons-material/ArrowDropDownOutlined'));
const ArrowDropUpOutlinedIcon = lazy(() => import('@mui/icons-material/ArrowDropUpOutlined'));
...
const AddEmployee = () => {
    ...
    const renderLoader = () => <p>Please wait while the form is loading...</p>;
